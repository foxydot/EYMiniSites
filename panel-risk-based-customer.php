<section class="panel risk-based-customer bkgimg" id="risk-based-customer">
    <div class="screen">
        <div class="wrap">
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel-risk-based-customer" role="button" data-slide="prev">
            ...
            <div id="carousel-risk-based-customer" class="carousel slide">
                <div class="carousel-inner">
                    <div class="item active qa">
                        <div class="interactive-question business-problem animate" id="rbc-business-problem">
                            ...
                            <div class="row interstitial">
                                <div class="col-md-11 col-md-offset-1">
                                    <a class="button" href="#rbc-business-opportunity">So what's the business opportunity? ></a>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-question business-opportunity animate" id="rbc-business-opportunity">
                    ...
                    <div class="item demo" id="risk-based-customer-demo">
                        ...
                        <div class="interactive-demo1 animate" id="rbc-rick-1">
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-md-11">
                                    <a class="button" href="#rbc-anne-1">See what happens next ></a>
                        ...
                        <div class="interactive-demo1 animate" id="rbc-anne-1">
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-md-11">
                                    <a class="button" href="#rbc-rick-2">See what happens next ></a>
                    ...
                    <div class="item tools" id="risk-based-customer-tools">
                        <div class="row">
