<section class="panel intelligent-cross-selling bkgimg" id="intelligent-cross-selling">
    <div class="screen">
        <div class="wrap">
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel-intelligent-cross-selling" role="button" data-slide="prev">
                ...
                <div class="col-sm-6 col-sm-offset-4">
                    ...
                    <div class="tagline-wrapper row">
                        <div class="equal tagline-icon col-sm-2">
                            <img src="./img/EY_%20DI_Innovation_Center_icons_intelligent_cross_selling.png" class="icon" />
                        </div>
            ...
            <div id="carousel-intelligent-cross-selling" class="carousel slide">
                <div class="carousel-inner">
                    <div class="item active qa">
                        <div class="interactive-question business-problem animate" id="ics-business-problem">
                    ...
                    <div class="item demo" id="intelligent-cross-selling-demo">
                        <div class="interactive-demo1 animate" id="ics-john-1">
                            <div class="row block even">
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-sm-11">
                                    <a class="button" href="#ics-dan-1">See what happens next ></a>
                                    <div class="button-replacement"></div>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-demo1 animate" id="ics-dan-1">
                            <div class="row block even">
                                <div class="col-sm-2 bkg-yellow a">
                                ...
                                <div class="col-sm-10 bkg-white20 c">
                                    ...
                                    <div class="col-sm-7 animate-icons">
                                        ...
                                        <img class="dan-1-b" src="img/dan-1-b.png" />
                                    </div>
                                </div>
                            </div>
                            <div class="row interstitial">
                                ...
                                <div class="col-sm-11">
                                    <a class="button" href="#ics-john-2">See what happens next ></a>
                                    <div class="button-replacement"></div>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-demo1 animate" id="ics-john-2">
                            <div class="row block even">
                                <div class="col-sm-2 bkg-yellow a">
                                    <img class="img-circle human-headshot" src="img/headshot-john.jpg" />
                                    <h5 class="human-name">John</h5>
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-sm-11">
                                    <a class="button" href="#ics-abe-1">See what happens next ></a>
                                    <div class="button-replacement"></div>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-demo1 animate" id="ics-abe-1">
                            <div class="row block even">
                                <div class="col-sm-2 bkg-yellow a">
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-sm-11">
                                    <a class="button" href="#ics-john-3">See what happens next ></a>
                                    <div class="button-replacement"></div>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-demo1 animate" id="ics-john-3">
                            <div class="row block even">
                                <div class="col-sm-2 bkg-yellow a">
                                    <img class="img-circle human-headshot" src="img/headshot-john.jpg" />
                                    <h5 class="human-name">John</h5>
                                ...
                                <div class="col-sm-10 bkg-white20 c">
                                    <ul class="col-sm-5 animate-ul">
                                        <li>Reviews Abe's suggestion and is impressed by the savings opportunity</li>
                            ...
                            <div class="row interstitial">
                                ...
                                <div class="col-sm-11">
                                    <a class="button" href="#ics-abe-2">See what happens next ></a>
                                    <div class="button-replacement"></div>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-demo1 animate" id="ics-abe-2">
                            <div class="row block even">
                                <div class="col-sm-2 bkg-yellow a">
                                    <img class="img-circle human-headshot" src="img/headshot-abe.jpg" />
                                    <h5 class="human-name">Abe</h5>
