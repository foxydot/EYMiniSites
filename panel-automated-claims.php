<section class="panel automated-claims bkgimg" id="automated-claims">
    <div class="screen">
        <div class="wrap">
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel-automated-claims" role="button" data-slide="prev">
            ...
            <div id="carousel-automated-claims" class="carousel slide">
                        ...
                        <div class="interactive-question business-problem animate" id="act-business-problem">
                            ...
                            <div class="row interstitial">
                                <div class="col-md-11 col-md-offset-1">
                                    <a class="button" href="#act-business-opportunity">So what's the business opportunity? ></a>
                                </div>
                            </div>
                        </div>
