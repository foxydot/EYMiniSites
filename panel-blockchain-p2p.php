<section class="panel blockchain-p2p bkgimg" id="blockchain-p2p">
    <div class="screen">
        <div class="wrap">
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel-blockchain-p2p" role="button" data-slide="prev">
            ...
            <div id="carousel-blockchain-p2p" class="carousel slide">
                        ...
                        <div class="interactive-question business-problem animate" id="p2p-business-problem">
                            ...
                            <div class="row interstitial">
                                <div class="col-md-11 col-md-offset-1">
                                    <a class="button" href="#p2p-business-opportunity">So what's the business opportunity? ></a>
                                </div>
                            </div>
                        </div>
