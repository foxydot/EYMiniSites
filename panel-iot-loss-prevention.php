<section class="panel iot-loss-prevention bkgimg" id="iot-loss-prevention">
    <div class="screen">
        <div class="wrap">
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel-iot-loss-prevention" role="button" data-slide="prev">
            ...
            <div id="carousel-iot-loss-prevention" class="carousel slide">
                <div class="carousel-inner">
                    <div class="item active qa">
                        <div class="interactive-question business-problem animate" id="ilp-business-problem">
                            ...
                            <div class="row interstitial">
                                <div class="col-md-11 col-md-offset-1">
                                    <a class="button" href="#ilp-business-opportunity">So what's the business opportunity? ></a>
                                </div>
                            </div>
                        </div>
                        <div class="interactive-question business-opportunity animate" id="ilp-business-opportunity">
                    ...
                    <div class="item tools" id="iot-loss-prevention-tools">
                        <div class="row">
